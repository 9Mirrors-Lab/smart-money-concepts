  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-10 border-b border-border bg-background/95 backdrop-blur">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold">Engine 2 logic inventory</h1>
              <p className="text-sm text-muted-foreground">
                Decision ladder in the order gates fire: alignment → confidence → bias.
              </p>
            </div>
          </div>
          <Engine2Nav />
      ...
      <main className="mx-auto max-w-5xl space-y-8 px-4 py-6">
        ...
        <p className="text-sm text-muted-foreground">
          Numbers below are defaults; the <Link href="/engine2-diagnostic-flow" className="text-primary underline">Diagnostic flow</Link> page shows rules for the version currently in use in <Link href="/engine2-tune" className="text-primary underline">Tune</Link>.
        </p>
