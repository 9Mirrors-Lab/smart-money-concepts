...
>(({ className, align = "start", sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "bg-popover text-popover-foreground z-50 max-h-[var(--radix-popover-content-available-height)] w-full min-w-[12rem] origin-[var(--radix-popover-content-transform-origin)] overflow-y-auto rounded-md border border-border p-3 shadow-md",
...
const PopoverHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col gap-1.5 pb-2", className)} {...props} />
);
